...
def radioflux(file,bgfile,fgr,bgr=None,individual=False,action='Flux',fluxerr=0,nsigma=0,verbose=False,output=None):
...
if __name__ == "__main__":
    ...
    radioflux(args.file, args.bgfile, args.fgr,args.bgr,args.indiv,args.action,args.fluxerr,args.nsigma,verbose=args.verbose, output=args.outname)
